...
export var vlice = '!Иванов Иван Аристархович'

export function varperem (obj) {
	console.log('PDF', obj)
	docInfo.content[3] = 'Общество с ограниченной ответственностью «ЦЕНТР СЕРТИФИКАЦИИ И ИСПЫТАНИЙ»,  именуемое в дальнейшем  «Исполнитель»,  в лице Генерального директора Устименко Виктории Андреевны, действующего на основании Устава, с одной стороны, и "' + (obj.zakazchik || zakazchik) + '" именуемое в дальнейшем «Заказчик», в лице ' + vlice + ' действующего на основании ______________________________, с другой стороны, заключили настоящий Договор о нижеследующем:'
}
